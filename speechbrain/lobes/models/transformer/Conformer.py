...
This library connects SummaryMixing to the standard SpeechBrain lobes for Conformer ASR.
...
class ConformerEncoderLayer(nn.Module):
    ...
    local_hid_dim: list [int], optional
    ...
    def forward(
        ...
        skip = x
        x = self.norm1(x)
        if not self.attention_type == "SummaryMixing":
